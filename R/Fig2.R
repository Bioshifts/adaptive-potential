...
## allW_TE GDeff
res=read.csv2(here(dir.out,"summary_GDeff_allW_TE.csv"),
              sep=";",dec=".",h=T) 
c1=read.csv2(here(dir.out,"summary_coeff.csv"),
             sep=";",dec=".",h=T)
...
## allW_CE GDeff
res=read.csv2(here(dir.out,"summary_GDeff_allW_CE.csv"),
              sep=";",dec=".",h=T) 
c1=read.csv2(here(dir.out,"summary_coeff.csv"),
             sep=";",dec=".",h=T)
...
## allW_LE GDeff
res=read.csv2(here(dir.out,"summary_GDeff_allW_LE.csv"),
              sep=";",dec=".",h=T) 
c1=read.csv2(here(dir.out,"summary_coeff.csv"),
             sep=";",dec=".",h=T)
...
png(here("Figs","fig2.png"),unit="cm",width=27,height=11,res=300)#,width=547,height=360
(p1a + p2a + p3a + gg_lega ) + 
